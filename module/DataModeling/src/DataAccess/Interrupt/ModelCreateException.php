...
class ModelCreateException extends Interrupt\ExceptionAbstract
{
    const MESSAGE = 'Attempting to create a new %2$s model failed in %1$s. SQL Exception Attached. Original Message: %3$s';
