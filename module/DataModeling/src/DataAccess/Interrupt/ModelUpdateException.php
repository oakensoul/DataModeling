...
class ModelUpdateException extends Interrupt\ExceptionAbstract
{
    const MESSAGE = 'Attempting to update a %2$s model failed in %1$s. SQL Exception Attached. Original Message: %3$s';
